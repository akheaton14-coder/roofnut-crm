...
export default function WorkflowEditor(){
  ...
  return <CrmShell userName={userName}><div className="content workflow-editor">
    <div className="workflow-head"><button onClick={()=>router.push("/pipeline")}>← Back to board</button><div><p className="eyebrow">WORKFLOW SETTINGS</p><h1>{name}</h1><p>Organize statuses inside each stage. Drag a status card into another stage to move it.</p></div><button className="primary-button" onClick={()=>add()}>＋ Add status</button></div>
